      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12 gap-6 animate-fade-in">
          <div className="text-center md:text-left">
            ...
            <h2 className="text-5xl md:text-7xl font-extrabold theme-brand-text drop-shadow-xl animate-text-shimmer" style={{backgroundSize: '200% auto'}}>
              Todos los Libros
            </h2>
          </div>
            ...
            >
              ...
              <div className="relative surface backdrop-blur-xl rounded-2xl overflow-hidden shadow-xl border-2 border-orange-200/50 dark:border-cyan-400/30 group-hover:border-orange-400/70 dark:group-hover:border-cyan-400/70 transition-all duration-500">
                ...
                <div className="p-6 text-center">
                  <h3 className="text-xl font-bold text-base-color mb-2 group-hover:theme-brand-text transition-colors duration-300">{book.title}</h3>
                  ...
                  <p className="text-muted text-sm mb-4 line-clamp-2 leading-relaxed">{book.summary}</p>
