...
const PoemDetailPage = ({ poem, setCurrentPage }) => {
    ...
    return (
      <section className="py-16 bg-gradient-to-br from-white via-purple-50/30 to-indigo-50/30 dark:from-gray-800 dark:via-purple-950/20 dark:to-indigo-950/20 min-h-screen flex items-center justify-center pt-24">
        <div className="text-center text-gray-700 dark:text-gray-300 animate-fade-in">
          <div className="mb-6">
            <svg className="w-24 h-24 mx-auto text-purple-600 dark:text-indigo-400 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-white via-purple-50/30 to-indigo-50/30 dark:from-gray-800 dark:via-purple-950/20 dark:to-indigo-950/20 min-h-screen pt-24 relative overflow-hidden">
      ...
      <div className="absolute bottom-10 left-10 w-96 h-96 bg-indigo-300/20 dark:bg-indigo-600/10 rounded-full blur-3xl animate-blob" style={{animationDelay: '2s'}}></div>
      ...
      <div className="container mx-auto px-6 max-w-3xl relative z-10">
        ...
        <div className="bg-gradient-to-br from-gray-100 to-gray-50 dark:from-gray-700 dark:to-gray-800 backdrop-blur-lg rounded-2xl shadow-2xl p-8 md:p-12 border-2 border-purple-200/50 dark:border-purple-700/50 animate-fade-in-up" style={{animationDelay: '150ms'}}>
          ...
          <h2 className="text-5xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent mb-8 text-center animate-fade-in" style={{animationDelay: '200ms'}}>{poem.title}</h2>
          <div className="prose prose-lg dark:prose-invert max-w-none animate-fade-in" style={{animationDelay: '300ms'}}>
