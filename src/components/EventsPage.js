    ...
    <section className="py-20 bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 dark:from-gray-900 dark:via-slate-800 dark:to-gray-900 min-h-screen pt-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <h2 className="text-5xl md:text-7xl font-extrabold theme-brand-text mb-6 drop-shadow-xl animate-text-shimmer" style={{backgroundSize: '200% auto'}}>
            Eventos y Noticias
          </h2>
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed font-light">
            Mantente al tanto de los próximos recitales, presentaciones y novedades
          </p>
        </div>
              ...
              <div className="relative surface backdrop-blur-xl rounded-2xl overflow-hidden shadow-xl border-2 border-orange-200/50 dark:border-cyan-400/30 group-hover:border-orange-400/70 dark:group-hover:border-cyan-400/70 transition-all duration-500">
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/30">
                    <span className="text-white text-sm font-bold">{event.date.split(',')[0]}</span>
                  </div>
                </div>
                
                {/* Contenido */}
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-base-color mb-3 group-hover:theme-brand-text transition-colors duration-300 leading-tight">{event.title}</h3>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-sm font-semibold text-base-color">{event.location}</span>
                  </div>
                  ...
                  <p className="text-muted text-sm mb-4 line-clamp-3 leading-relaxed">{event.description}</p>
        ...
        {events.length === 0 && (
          <div className="text-center py-16">
            <div className="inline-block mb-6">
              <svg className="w-24 h-24 mx-auto theme-brand-text opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <p className="text-xl text-muted font-light">No hay eventos programados por el momento</p>
            <p className="text-base text-muted mt-2">¡Mantente al tanto de las próximas novedades!</p>
          </div>
        )}
      </div>
    </section>
