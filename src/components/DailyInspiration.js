...
const DailyInspiration = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-purple-600 via-fuchsia-500 to-pink-500 dark:from-indigo-950 dark:via-purple-900 dark:to-fuchsia-900 text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-36 h-36 bg-white/12 rounded-full blur-2xl animate-float1" style={{animationDelay: '1s'}}></div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <h2 className="text-6xl md:text-7xl font-extrabold mb-12 animate-text-shimmer bg-gradient-to-r from-white via-yellow-200 to-white bg-clip-text text-transparent drop-shadow-2xl" style={{backgroundSize: '200% auto'}}>
          Inspiración Diaria
        </h2>
        ...
        <div className="relative max-w-4xl mx-auto group">
          ...
          <div className="relative bg-white/25 dark:bg-black/30 backdrop-blur-2xl rounded-3xl p-12 md:p-16 shadow-2xl border-2 border-white/40 dark:border-white/20 transform transition-all duration-700 hover:scale-[1.02] hover:shadow-[0_0_80px_rgba(255,255,255,0.3)] animate-fade-in-up">
            ...
            <div className="mb-8 transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-6">
              <svg className="w-16 h-16 mx-auto text-white/70 drop-shadow-lg" fill="currentColor" viewBox="0 0 24 24">
                <path d="M6 17h3l2-4V7H5v6h3zm8 0h3l2-4V7h-6v6h3z"/>
              </svg>
            </div>
            
            {/* Título del poema */}
            <h3 className="text-4xl md:text-5xl font-bold mb-8 italic text-white drop-shadow-xl animate-fade-in leading-tight" style={{animationDelay: '200ms'}}>
              "{dailyPoem.title}"
            </h3>
            
            {/* Separador decorativo */}
            <div className="w-24 h-1 bg-gradient-to-r from-transparent via-white to-transparent mx-auto mb-8 animate-fade-in" style={{animationDelay: '300ms'}}></div>
            
            {/* Contenido del poema */}
            <p className="text-xl md:text-2xl leading-relaxed mb-10 line-clamp-6 text-white/95 drop-shadow-lg font-light animate-fade-in" style={{animationDelay: '400ms'}}>
              {dailyPoem.content}
            </p>
            
            {/* Firma del autor */}
            <div className="pt-8 border-t-2 border-white/30 animate-fade-in" style={{animationDelay: '600ms'}}>
