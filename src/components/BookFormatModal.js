      ...
      >
        ...
        >
          <svg
            ...
            className="h-6 w-6 text-base-color"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-muted">Elige el formato que prefieres</p>
        </div>
            ...
            Object.entries(book.formats).map(([format, link]) => (
              ...
              >
                ...
                <div className="relative flex items-center justify-between">
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6 text-brand group-hover:translate-x-1 transition-transform"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
