...
const AdminDashboardPage = ({ setCurrentPage, setIsLoggedIn }) => {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-gray-50 via-purple-50/30 to-indigo-50/30 dark:from-gray-900 dark:via-purple-950/30 dark:to-indigo-950/30 min-h-screen pt-24 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-20 right-10 w-96 h-96 bg-indigo-300/20 dark:bg-indigo-600/10 rounded-full blur-3xl animate-blob"
      ...
      <div className="container mx-auto px-6 max-w-3xl relative z-10">
        ...
        <div
          className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 md:p-12 mb-8 border border-purple-200/50 dark:border-purple-700/50 animate-fade-in-up"
