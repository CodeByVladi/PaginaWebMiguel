      ...
      <nav className="relative container mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
        <div className="group text-lg sm:text-xl md:text-2xl font-bold hover:scale-105 transition-all duration-300 cursor-pointer">
          <span className="relative inline-block">
            <span className="hidden sm:inline bg-gradient-to-r from-amber-600 via-orange-500 to-red-600 dark:from-cyan-400 dark:via-blue-400 dark:to-indigo-400 bg-clip-text text-transparent drop-shadow-sm">Versos de Miguel Ángel</span>
            <span className="sm:hidden bg-gradient-to-r from-amber-600 via-orange-500 to-red-600 dark:from-cyan-400 dark:via-blue-400 dark:to-indigo-400 bg-clip-text text-transparent drop-shadow-sm">Miguel Ángel</span>
